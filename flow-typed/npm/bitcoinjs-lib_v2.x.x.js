// flow-typed signature: 70d3dbcb0d27461d8b285b80a79dc303
// flow-typed version: da30fe6876/bitcoinjs-lib_v2.x.x/flow_>=v0.25.x
...
declare module "bitcoinjs-lib" {
  ...
  declare var script: {
    ...
    isScriptHashInput(
      script: Array<Buffer | number> | Buffer,
    ...
    witnessScriptHashInput(
      scriptSig: Array<Buffer | number> | Buffer,
  ...
  declare class TransactionBuilder {
    ...
    addInput(
      txhash: string | Transaction | Buffer,
      vout: number,
      sequence?: number,
      prevOutScript?: Buffer
    ): void;
